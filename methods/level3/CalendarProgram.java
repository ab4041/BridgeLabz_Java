...
Hint =>
Define a month array to store month names
Define a days array to store number of days
Check leap year for February
Use Gregorian calendar algorithm to find first day of month
Use loops to print calendar
*/
