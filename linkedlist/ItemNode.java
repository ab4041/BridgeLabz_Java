...
class InventorySLL {
    ...
    // Sorting by itemName or price, asc/desc
    ...
    private ItemNode mergeSort(ItemNode node, boolean byName, boolean ascending) {
        ...
        ItemNode rightHead = mid.next;
        mid.next = null; // split list

        ItemNode left = mergeSort(node, byName, ascending);
        ItemNode right = mergeSort(rightHead, byName, ascending);
...
public class Main4_Inventory {
    public static void main(String[] args) {
        ...
        inv.displayAll();
        System.out.println("Total Inventory Value = " + inv.totalInventoryValue());
