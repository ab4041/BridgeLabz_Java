...
class TicketReservationCLL {
    ...
    public void displayTickets() {
        ...
        TicketNode temp = head;
        do {
            System.out.println("TicketID=" + temp.ticketId + " | " + temp.customerName + " | " + temp.movieName +
    ...
    public void searchByMovieName(String movie) {
        ...
        do {
            if (temp.movieName.equalsIgnoreCase(movie)) {
                System.out.println("Found Ticket: " + temp.ticketId + " Customer=" + temp.customerName + " Seat=" + temp.seatNumber);
                found = true;
            }
            temp = temp.next;
        } while (temp != head);
...
public class Main9_TicketReservation {
